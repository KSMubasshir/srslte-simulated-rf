...
# Add Malicious EPC node
epc2 = request.RawPC("epc_fake")
epc2.hardware_type = GLOBALS.HWTYPE
epc2.disk_image = GLOBALS.SRSLTE_IMG
iface2 = epc2.addInterface("eth1")
iface2.addAddress(rspec.IPv4Address("10.10.1.2", "255.255.255.0"))

# Add eNB node
enb1 = request.RawPC("enb_real")
...
# Add Malicious eNB node
enb2 = request.RawPC("enb_fake")
